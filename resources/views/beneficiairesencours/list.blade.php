...
@section('content')
        ...
        <section class="content-header">
            <h1>
            Mise à jour bénéficiaires en attente
        ...
        <section class="content">
			...
			@if ($beneficiaire->deleted == 1) Suppression @else Ajout @endif
                                        ...
                                        <td>
                                         <a    href="/admin/beneficiaireencours/validate/{{ $beneficiaire->identifiant }}" class="btn btn-xs btn-default"><i style="color:green;" class="fa fa-check"></i></a>
                                            <a href="/admin/beneficiaireencours/edit/{{ $beneficiaire->identifiant }}" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                            <a href="/admin/beneficiaireencours/delete/{{ $beneficiaire->identifiant }}" onclick="return confirm('Supprimer ce bénéficiaire ?')" class="btn btn-xs btn-default"><i style="color:red;" class="fa fa-times-circle"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
