...
@section('content')
        ...
        <section class="content">
			...
			@if ($beneficiaire->deleted == 1) Suppression @else Ajout @endif
					...
					<td>
			                    <a href="/admin/nouveauteWalls/validate/{{ $beneficiaire->identifiant }}" class="btn btn-xs btn-default"><i style="color:green;" class="fa fa-check"></i></a>
                                            <a href="/admin/nouveauteWalls/edit/{{ $beneficiaire->identifiant }}" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                            <a href="/admin/nouveauteWalls/delete/{{ $beneficiaire->identifiant }}" onclick="return confirm('Supprimer ce bénéficiaire ?')" class="btn btn-xs btn-default"><i style="color:red;" class="fa fa-times-circle"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="row">
                <div class="col-xs-12">
					...
					<th>Média</th>
                                        ...
                                        <td>
                                           @if ($beneficiaire->handicape == 0) o @else  oh @endif -{{ $beneficiaire->id }}
                                                        ...
                                                        @if ($beneficiaire->type == "image")
                                                                                ...
                                                                                <a href="{{url('uploads/'.$beneficiaire->link)}}">
					    ...
					    <a href="/admin/nouveauteMedia/validate/{{ $beneficiaire->identifiant }}" class="btn btn-xs btn-default"><i style="color:green;" class="fa fa-check"></i></a>
                                            <!--<a href="/admin/nouveauteMedia/edit/{{ $beneficiaire->identifiant }}" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>-->
                                            <a href="/admin/nouveauteMedia/delete/{{ $beneficiaire->identifiant }}" onclick="return confirm('Supprimer ce bénéficiaire ?')" class="btn btn-xs btn-default"><i style="color:red;" class="fa fa-times-circle"></i></a>
