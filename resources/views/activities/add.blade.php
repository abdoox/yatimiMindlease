...
@section('content')
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">Ajouter une activité</div>
                        <div class="box-body">
                            <form method="POST" action="/admin/activities/store"  enctype="multipart/form-data">
                                {{ csrf_field() }}
								<div class="row">
								...
								<div class="row" style="padding:15px;">
									...
									<div class="col-md-6">
										<div class="form-group ">
											...
											<textarea  required class="form-control" dir="rtl" name="description_ar"  cols="50"> </textarea>
										</div>
									</div>
								</div>
 <div class="row" style="padding:15px;">
