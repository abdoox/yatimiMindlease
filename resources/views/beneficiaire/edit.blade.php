            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form method="POST" action="/admin/beneficiaire/update"  enctype="multipart/form-data">
                                {{ csrf_field() }}
								<div class="row">
								...
								<div class="row">
									...
									<div class="form-group col-xs-6">
										...
										<select name="association_id" class="form-control">
											...
											<option value="{{$association->id}}" @if($beneficiaire->association_id == $association->id) selected="selected" @endif>{{$association->name}}</option>
											@endforeach
										</select>
									</div>
									...
									<div class="form-group col-xs-6">
                                                                                ...
                                                                                <select name="city_id" class="form-control">
                                                                                        ...
                                                                                        <option value="{{$city->id}}"  @if($association->city_id == $city->id) selected="selected" @endif>{{$city->label}}</option>
                                                                                        @endforeach
                                                                                </select>
                                                                        </div>
								</div>
		...
		<div class="col-md-6">
											...
											@if ($beneficiaireSuperieur != null)					
											 ...
											 @if ($beneficiaireSuperieur == null)
                                                                                                ...
                                                                                                <input type="number" step="0.01" max="20.00" min="0.0" name="noteBac" value=""  class="form-control">
                                                                                                @endif
                                                                                ...
                                                                                <div class="form-group ">
                                                                                        <label>Charges financières des études : </label>
                                                                                         ...
                                                                                         @if ($beneficiaireSuperieur == null)
                                                                                                ...
                                                                                                <input type="number" min ="0" name="charges" value=""  class="form-control">
                                                                                                @endif
								...
								<h3 style="padding:15px;">
									...
									<a href="/admin/create/image/{{$beneficiaire->id}}" class="btn btn-primary ladda-button pull-right" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Ajouter un média</span></a>
								</h3> 
						...
						@elseif ($image->type == 'audio')
										...
										<a href="/admin/image/delete/{{ $image->id }}" class="btn btn-xs btn-default pull-right"><i class="fa fa-trash"></i> Supprimer</a>
									</li>
								...
								<h3 style="padding:15px;">
									...
									<a href="/admin/create/wall/{{$beneficiaire->id}}" class="btn btn-primary ladda-button pull-right" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Ajouter une activité</span></a>
								</h3> 
								<ul class="list-group" style="padding:15px;">
								@foreach ($beneficiaire->walls_beneficiaire as $wall)
									<li class="list-group-item">
									    ...
									    <a href="{{url('uploads/'.$wall->image)}}">
                                                ...
                                                @endif
										<a href="/admin/wall/delete/{{ $wall->id }}" class="btn btn-xs btn-default pull-right"><i class="fa fa-trash"></i> Supprimer</a>
									</li>
