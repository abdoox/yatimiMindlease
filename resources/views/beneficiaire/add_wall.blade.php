            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form method="POST" action="/admin/wall/store"  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <a href="/admin/beneficiaire/edit/{{$id}}" class="btn btn-default"><span class="fa fa-ban"></span> Annuler</a>
                            </form>
                        </div>
                    </div>
                </div>
