...
@section('content')
                ...
                <div class="col-xs-12">
                    <div class="box">
                       <div class="box-header with-border">
						   ...
						   <a href="association/beneficiaire/excel" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Générer fichier excel</span></a>
	<!--				
	...
	<p  style="font-size:20px;padding:25px;">Le nombre total des orphelins est <strong>{{$nbrTotalBen}}</strong> dont <strong>{{$nbrParraineBen}}</strong> sont parrainés et <strong>{{$nbrNonParraineBen}}</strong> non parrainés.</p>
...
<a href="/association/beneficiaire/parrainages/{{ $beneficiaire->id }}" class="btn btn-xs btn-default"><i class="fa fa-bars"></i></a>
