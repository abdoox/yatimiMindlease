                ...
                <div class="col-xs-12">
                    <div class="box">
                       <div class="box-header with-border">
						   ...
						   <a href="association/beneficiaire/excel2" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Générer fichier excel</span></a>

	<p  style="font-size:20px;padding:25px;">Le nombre des orphelins parrainés est <strong>{{$nbrParraineBen}}</strong>.</p>
