...
<a  style="margin : 20px;"  href="association/prise_en_charge_termine/excel" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Exporter Excel</span></a>
...
<section class="content">
	...
	<div class="row">
                ...
                <div class="col-xs-12">
                    <div class="box">
        <p  style="font-size:20px;padding:25px;">Le nombre des parrainages annulés est  <strong>{{$nbr}}</strong>.</p>
