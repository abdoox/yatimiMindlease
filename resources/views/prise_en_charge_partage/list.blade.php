...
<a  style="margin : 20px;"  href="prise_en_charge_partage/export" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Exporter Excel</span></a>
<a  style="margin : 20px;"  href="prise_en_charge_partage/pdf" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Exporter PDF</span></a>
