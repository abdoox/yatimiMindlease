...
@section('content')
        ...
        <section class="content">
           <div class="row"> 
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">Ajouter un utilisateur</div>
                        <div class="box-body">
                            <form method="POST" action="/admin/utilisateur/store"  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                                               <div class="row">
...
class="form-control"                                   type="password"
                                    >
									       ...
									       <div class="form-group col-xs-4">
                                                                                <label>Lastname</label>    <label>*</label>
...
<div class="form-group col-xs-4">
                                                                                <label>Firstname</label>    <label>*</label>
