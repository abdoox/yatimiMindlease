...
@section('content')
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">Modifier une nouveauté</div>
                        <div class="box-body">
                            <form method="POST" action="/admin/news/update"  enctype="multipart/form-data">
								...
								<div class="row">
                                    ...
                                    <div class="form-group col-xs-4">
										<label>titre</label>
                                        <input type="text" name="title" value="{{$news->title}}" required class="form-control">
									</div>
									<div class="form-group col-xs-4">
										<label>détail</label>
										<textarea  required class="form-control" name="detail"  cols="50"> {{$news->detail}} </textarea>
									</div>
    ...
    <div class="form-group col-xs-6">
							...
							@if ($news->type == "image")
										 <a href="{{url('uploads/'.$news->image)}}">

										
                                                                                        <img src="{{url('uploads/'.$news->image)}}" style="
                                                                                                          max-height: 100px;
													  width: 100px;
													  margin : 10px;		
                                                                                                          border-radius: 3px;">
									    </a>
							@else <a href="{{url('uploads/'.$news->image)}}">
