...
class ExportPriseTermineAssoc implements FromCollection, WithHeadings
{
    ...
    public function headings() : array
	        {
			        return ["ID parrain","ID bénéficiaire","Prénom orphelin","Nom orphelin","Âge","sexe","état de santé ( handicapé : 1 )","date de création d'orphelin","montant de parrainage","date du parrainage","date d'annulation de parrainage"];
    }
}
